...
| uv run --no-sync pytest -q | 7 passed | FDR, HAC summary, holdout, PnL gate, LLM fallback and demo |
| python -m strategy_lab_showcase.demo | Deterministic FAIL | Seeded synthetic input only |
