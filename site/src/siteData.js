...
export const PROJECTS = [
  ...
  },
  {
    ...
    status: "In progress",
    featured: false,
    summary: "A learning and research product with a separate, smaller public code sample for portfolio review.",
    ...
    liveUrl: "https://xn--synthvia-f1a.com/",
  },
  {
    id: "gargantua",
    number: "04",
  ...
  },
  {
    ...
    featured: false,
    summary: "A synthetic trace walkthrough that makes an expected tool-call rejection understandable without presenting it as an application failure.",
  ...
  },
  {
    ...
    status: "Prepared browser demo",
    featured: false,
    summary: "A synthetic comparison walkthrough that exposes matching signals, disagreement and the boundary against false certainty.",
  ...
  },
  {
    ...
    status: "Prepared browser demo",
    featured: false,
    summary: "A guided synthetic migration record that shows the sequence, evidence and a documented local runtime limit.",
